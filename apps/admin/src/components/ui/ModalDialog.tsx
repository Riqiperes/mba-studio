...
interface ModalDialogProps {
  ...
  id?: string | undefined;
  /** Ancho en escritorio: md (formularios cortos) o lg (formularios largos). */
 ...
 */
export function ModalDialog({ open, onClose, title, description, children, footer, id, size = "md" }: ModalDialogProps) {
  ...
  return (
    <dialog
      ...
      className={`modal-dialog focus-visible:outline-none m-0 mt-auto w-full max-w-none overscroll-contain rounded-t-card bg-tarjeta p-0 text-texto shadow-sheet sm:m-auto sm:rounded-card ${size === "lg" ? "sm:max-w-2xl" : "sm:max-w-md"}`}
    >
